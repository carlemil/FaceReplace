        ...
        if (bitmap != null) {
            ...
            for(int i = 0; i < eyesMidPts.length; i++) {
                if (eyesMidPts[i] != null) {
                    ...
                    // canvas.drawCircle(eyesMidPts[i].x * xRatio, eyesMidPts[i].y * yRatio, eyesDistance[i] / 2, tmpPaint);
                    // canvas.drawCircle(eyesMidPts[i].x * xRatio, eyesMidPts[i].y * yRatio, eyesDistance[i] / 6, tmpPaint);
                    ...
                    float bottom = eyesMidPts[i].y * yRatio + eyesDistance[i] * GOLDEN_RATIO * yRatio;
